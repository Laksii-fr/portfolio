        ...
        if (!formData.name || !formData.email || !formData.subject || !formData.body) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alert("Error sending email, no problem mail me directly at lakshyash5@gmail.com")
                }
            } catch (error) {
    ...
    return (
        <div className="max-w-lg w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
            ...
            <p className="text-neutral-600 text-md md:text-lg max-w-sm mt-4 dark:text-neutral-300">
                Got a question or proposal, Go ahead.
            </p>
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input id="name" placeholder="Lakshay" type="text" value={formData.name} onChange={handleChange} />
                </LabelInputContainer>

                <LabelInputContainer className="mb-4">
                    <Label htmlFor="email">Email Address</Label>
                    <Input id="email" placeholder="lakshyash5@gmail.com" type="email" value={formData.email} onChange={handleChange} />
                </LabelInputContainer>
